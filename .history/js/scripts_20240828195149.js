...
function iniciarAplicacao() {
    ...
    const elementos = {
        ...
        excluirImagem: '[data-js="excluir-imagem"]',
    }
    ...
    const excluirImagem = document.querySelector(elementos.excluirImagem);
    ...
    excluirImagem.addEventListener('click', excluirImagemApresentada);
